  ...
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  getReport(): void {
    if (
      ...
      this.msg.showError('Corporate and Test fields are required.');
      return;
    }
    var spnames = `Call RN_GET_CORPORATE_TEST_REPORT('${this.corporateId}','${this.testId}')`;
    if (this.selectedAssesment != null && this.selectedAssesment != '') {
      spnames = `Call RN_GET_CORPORATE_TEST_REPORT_BY_ASSESMENT('${this.selectedAssesment}','${this.testId}')`;
    }
    const params = {
      query: spnames,
      params: '',
