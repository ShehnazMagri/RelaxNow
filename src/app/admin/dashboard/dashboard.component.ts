...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  getDashboardData(): void {
    ...
    this.http.postData(ApiUrl.common, params1).subscribe((doctorData) => {
      const result1 =
    ...
    this.http.postData(ApiUrl.common, params2).subscribe((patientData) => {
      const result2 =
    ...
    this.http.postData(ApiUrl.common, params3).subscribe((appointmentData) => {
      const result3 =
