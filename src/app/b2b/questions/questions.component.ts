...
@Component({
  selector: 'app-questions-b2b',
  templateUrl: './questions.component.html',
  styleUrls: ['./questions.component.css'],
})
export class QuestionsB2BComponent implements OnInit {
  ...
  ngOnInit(): void {
    debugger;
    this.testId = parseInt(this.TESTID);
    if (
  ...
  submitTest() {
    ...
    this.bColor = color;
    this.http.postData('/report/reportwithoutemail', params).subscribe(
      (resp: any) => {
        if (!!resp) {
